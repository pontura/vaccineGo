...
namespace KeenResearch {
	...
	public class KeenASR {
		...
		public delegate void PartialASRResultHandler(string text); // TODO - full ASR result instead of text
...
//		private KeenASRListener listener;
		...
		private class KeenASRListener : MonoBehaviour {
			...
			private void FinalASRResult(string jsonResult) {
				...
				if (handler == null) {
					Debug.Log ("No handler for the final result is set in KeenASR.");
					return;
				}
